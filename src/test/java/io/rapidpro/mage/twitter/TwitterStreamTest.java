...
public class TwitterStreamTest extends BaseTwitterTest {
    ...
    public void createAndStart() throws Exception {
        ...
        assertThat(querySingle("SELECT bod FROM channels_channel WHERE id = -44").get("bod"), is("240136858829479936|0"));
        ...
        assertThat(querySingle("SELECT bod FROM channels_channel WHERE id = -44").get("bod"), is("240136858829479936|2960784075"));
